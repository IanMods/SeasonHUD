...
public class SeasonHUDScreen extends Screen{
    ...
    public void init() {
        ...
        ExtendedButton cancelButton = new ExtendedButton((this.width / 2 - (PADDING + BUTTON_WIDTH_HALF)), this.height - MENU_PADDING_HALF, BUTTON_WIDTH_HALF, BUTTON_HEIGHT, Component.translatable("gui.cancel"), b -> {
            mc.setScreen(this.lastScreen);
        });
