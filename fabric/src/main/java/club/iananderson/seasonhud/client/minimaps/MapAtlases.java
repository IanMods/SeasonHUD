...
public class MapAtlases implements HudRenderCallback {
  ...
  public static void drawScaledText(PoseStack poseStack, float x, float y, MutableComponent text, float textScaling,
  ...
  public static void drawMapComponentSeason(PoseStack poseStack, int x, int y, int originOffsetWidth,
